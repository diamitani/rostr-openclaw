...
## 5. Reasoning Logic
1. PAL extraction (verb, object, domain, constraints)
...
Status updates: concise, decision-oriented, 1-2 lines after completion
...
```
workspace/.rostr/
  context/identity.md        # Who you are
  context/domain-knowledge.md # What you know
  context/user-context.md    # Whom you serve
  state/session.json         # Current session
  state/memory.jsonl         # Cross-session memory
  state/decisions.md         # Decision log
  state/learnings.jsonl      # Learning log
  knowledge-base/            # RAG DAL config
  tools/tool-manifest.yaml   # Tool definitions
```
